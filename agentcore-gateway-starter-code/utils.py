...
# Global constants for sleep durations
ROLE_CREATION_SLEEP_SECONDS = 10
LAMBDA_ROLE_CREATION_SLEEP_SECONDS = 100

# Global constants for test user credentials
TEMP_PASSWORD = 'Temp123!'
PERMANENT_PASSWORD = 'MyPassword123!'
...
def create_agentcore_role(agent_name):
    ...
    try:
        ...
        time.sleep(ROLE_CREATION_SLEEP_SECONDS)
...
def create_gateway_lambda(lambda_function_code_path) -> dict[str, int]:
    ...
    try:
        ...
        time.sleep(LAMBDA_ROLE_CREATION_SLEEP_SECONDS)
